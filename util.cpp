                                             ...
                                             const std::string& intf)
{
    EthernetInterfaceIntf::DHCPConf dhcp =
        EthernetInterfaceIntf::DHCPConf::False;
    ...
    if (values[0] == "true")
    {
        dhcp = EthernetInterfaceIntf::DHCPConf::True;
    }
    else if (values[0] == "ipv4")
    {
        dhcp = EthernetInterfaceIntf::DHCPConf::ipv4;
    }
    else if (values[0] == "ipv6")
    {
        dhcp = EthernetInterfaceIntf::DHCPConf::ipv6;
    }
    return dhcp;
}
