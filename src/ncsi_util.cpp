...
static void
    printNCSIPassthroughStats(const passthroughStatsResponse* passthroughResp)
{
    setlocale(LC_ALL, "");
...
CallBack NCSIPassthroughStatsCallBack = [](struct nl_msg* msg, void* arg) {
    ...
    *(int*)arg = 0;
    ...
    lg2::debug("NCSI Response packet type : {RESPONSE_PKT_TYPE}",
               ...
               passthroughResp->passStatsRespHdr.type);
    ...
    passthroughResp->txUndersizeErr = ntohl(passthroughResp->txUndersizeErr);
    passthroughResp->txOversizeErr = ntohl(passthroughResp->txOversizeErr);
    passthroughResp->rxPacketsRcvdOnLan =
    ...
    passthroughResp->rxUndersizeErr = ntohl(passthroughResp->rxUndersizeErr);
    passthroughResp->rxOversizeErr = ntohl(passthroughResp->rxOversizeErr);

    printNCSIPassthroughStats(
        static_cast<const passthroughStatsResponse*>(passthroughResp));
