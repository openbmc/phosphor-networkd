...
std::array<unsigned char, 12> generateDumpCmdPayload(uint32_t chunkNum, uint32_t dataHandle, bool isAbort)
{
             ...
             const std::string& dataHandleStr)
{
    ...
    {
        std::array<unsigned char, 12> payload = generateDumpCmdPayload(chunkNum, dataHandle, transfer.isAbort());
