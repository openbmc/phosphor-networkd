...
getParamResponse extractGetParamData(const std::byte* data)
{
...
CallBack paramCallback = [](struct nl_msg* msg, void* arg) {
    ...
    *(int*)arg = 0;
    ...
    auto paramResp = extractGetParamData(data);
    ...
    printNCSIGetParam(
        static_cast<const NCSIGetParametersResponse*>(&paramResp.paramResp));
