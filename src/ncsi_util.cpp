...
{
    NCSIControllerPacketStatsResponse* rcv_buf = static_cast<NCSIControllerPacketStatsResponse*>
        (static_cast<void*>(raw_data));
    rcv_buf->countersClearedFromLastReadMSB = ntohl(rcv_buf->countersClearedFromLastReadMSB);
    rcv_buf->countersClearedFromLastReadLSB = ntohl(rcv_buf->countersClearedFromLastReadLSB);
    ...
    rcv_buf->multipleCollisionTxFrames = ntohl(rcv_buf->multipleCollisionTxFrames);
    rcv_buf->lateCollisionFrames = ntohl(rcv_buf->lateCollisionFrames);
    rcv_buf->excessiveCollisionFrames = ntohl(rcv_buf->excessiveCollisionFrames);
    ...
    printNCSIControllerStats(static_cast<const NCSIControllerPacketStatsResponse*>(rcv_buf));
...
void printNCSIControllerStats(const NCSIControllerPacketStatsResponse* pResp)
{
    ...
    std::cout
        ...
        << "\nTotal Unicast Packet Transmitted: "
        << pResp->totalUnicastPktsTx
        ...
        << pResp->excessiveCollisionFrames
        ...
        << pResp->rxFrame_128_255
        << "\n256-511 Byte Frames Received: "
        << pResp->rxFrame_256_511
        << "\n512-1023 Byte Frames Received: "
        << pResp->rxFrame_512_1023
        << "\n1024-1522 Byte Frames Received: "
        << pResp->rxFrame_1024_1522
        << "\n1523-9022 Byte Frames Received: "
        << pResp->rxFrame_1523_9022
        << "\n64-Byte Frames Transmitted: " << pResp->txFrame_64
        << "\n65-127 Byte Frames Transmitted: "
        << pResp->txFrame_65_127
        << "\n128-255 Byte Frames Transmitted: "
        << pResp->txFrame_128_255
        << "\n256-511 Byte Frames Transmitted: "
        << pResp->txFrame_256_511
        << "\n512-1023 Byte Frames Transmitted: "
        << pResp->txFrame_512_1023
        << "\n1024-1522 Byte Frames Transmitted: "
        << pResp->txFrame_1024_1522
        << "\n1523-9022 Byte Frames Transmitted: "
        << pResp->txFrame_1523_9022
        << "\nValid Bytes Received: " << pResp->validBytesRcvd
        << "\nError Runt Packets Received: "
        << pResp->errRuntPacketsRcvd
        << "\nError Jabber Packets Received: "
        << pResp->errJabberPacketsRcvd
        << "\n";
}
