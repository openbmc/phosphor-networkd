...
// NCSI PACKET TYPE
// Control packet type to Enable Global Multicast Filtering
static constexpr auto ncsiCmdEnableGlobalMulticastFilter = 0x12;
...
CallBack enableGlobalMulticastFilterCallBack =
...
int enableGlobalMulticastFilter(int ifindex, int package, int channel)
{
    ...
    return internal::applyCmd(
        ...
        internal::Command(ncsi_nl_commands::NCSI_CMD_SEND_CMD,
                          ncsiCmdEnableGlobalMulticastFilter),
        package, channel, NONE, internal::enableGlobalMulticastFilterCallBack);
}
