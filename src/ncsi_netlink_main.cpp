...
int main(int argc, char** argv)
{
    ...
    else if (!(options)["dump-file"].empty() && !(options)["data-handle"].empty())
    {
        const std::string& fileName = options["dump-file"];
        const std::string& dataHandleStr = options["data-handle"];
