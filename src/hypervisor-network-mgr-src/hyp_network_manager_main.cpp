...
constexpr char HYP_DEFAULT_NETWORK_BUSNAME[] = "xyz.openbmc_project.Network.Hypervisor";
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    phosphor::network::HypNetworkMgr manager(bus, event, DEFAULT_HYP_NW_OBJPATH);
