 ...
 * @param[in] pResp - NCSI response buffer.
 * @returns void.
 */
void printNCSIControllerStats(const NCSIControllerPacketStatsResponse* pResp);

/* @brief  This function is used to converts a 64-bit/32-bit
 *         big-endian integer to a host-endian integer.
 * @param[in] raw_data - NCSI response data.
 * @returns void.
 */
