...
Neighbor::Neighbor(sdbusplus::bus_t& bus, Manager& parent,
                   const std::string& objPath) :
    Neighbor(bus, parent, objPath, "",
...
Neighbor::Neighbor(
    sdbusplus::bus_t& bus, Manager& parent, const std::string& objPath,
    ...
    manager(parent), objectPath(objPath)
{
