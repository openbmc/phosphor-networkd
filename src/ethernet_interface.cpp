...
{
    static auto fd =
        stdplus::fd::socket(static_cast<stdplus::fd::SocketDomain>(PF_INET),
                            static_cast<stdplus::fd::SocketType>(SOCK_DGRAM),
                            static_cast<stdplus::fd::SocketProto>(IPPROTO_IP));
    return fd;
}
