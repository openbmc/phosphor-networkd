...
static int ncsiDiscover(GlobalOptions& options)
{
         ...
         ++packageIndex)
    {
        ...
        for (unsigned int channelIndex = 0; channelIndex < maxChannelCount; ++channelIndex)
        {
        ...
        {
            std::cout << "  No valid channels found for Package " << packageIndex
                      << ". Moving to next package.\n";
        }
    } // end package loop
