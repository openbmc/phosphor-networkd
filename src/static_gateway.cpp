...
StaticGateway::StaticGateway(sdbusplus::bus_t& bus, std::string_view objRoot,
    ...
    StaticGateway(bus, makeObjPath(objRoot, gateway), parent, destination,
...
{
    StaticGatewayObj::destination(destination, true);
...
std::string StaticGateway::destination(std::string /*Destination Address*/)
{
