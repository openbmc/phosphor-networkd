...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr
        << "Options:\n"
           ...
           "    --enable-broadcast | -b Enable broadcast filtering.\n"
...
const option ArgumentParser::options[] = {
    ...
    {"enable-broadcast", no_argument, NULL, 'b'},
...
const char* ArgumentParser::optionStr = "irsbx:o:p:c:h?";
