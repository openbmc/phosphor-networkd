...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr
        << "Options:\n"
           ...
           "    --data-handle=<value> | -d <value> Specify data handle value.\n"
           "\n"
           "Example commands:\n"
           ...
           "    8} NCSI core dump\n"
           "         ncsi-netlink -x 2 -p 0 -c 31 -f core.log -d ffff0000\n"
           "    9} NCSI crash dump\n"
           "         ncsi-netlink -x 2 -p 0 -c 31 -f crash.log -d ffff0001\n"
           "\n";
}
...
const option ArgumentParser::options[] = {
    ...
    {"data-handle", required_argument, NULL, 'd'},
    {0, 0, 0, 0},
};
