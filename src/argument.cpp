...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr
        << "Options:\n"
           ...
           "    --NCSI-stats | -n Get NCSI statistics.\n"
           ...
           "    8) Get NCSI Statistics\n"
           "         ncsi-netlink -x 2 -p 0 -c 0 -n\n"
           "\n";
}
...
const char* ArgumentParser::optionStr = "irsnj:k:x:o:p:c:h?";
