...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr
        << "Options:\n"
           ...
           "    --egmf | -e      Enable Global Multicast Filter.\n"
           ...
           "    8) Enable Global Multicast Filter\n"
           "         ncsi-netlink -x 2 -p 0 -c 0 -e\n"
           "\n";
}
...
const char* ArgumentParser::optionStr = "irsej:k:x:o:p:c:h?";
