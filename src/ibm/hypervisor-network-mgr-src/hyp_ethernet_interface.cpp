...
const std::unique_ptr<HypIPAddress>&
...
void HypEthInterface::setBiosPropInDbus(
    std::unique_ptr<HypIPAddress> ipObj, std::string attrName,
    std::variant<std::string, uint8_t> attrValue)
{
