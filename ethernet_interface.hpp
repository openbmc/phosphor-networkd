...
class EthernetInterface : public Ifaces
{
  ...
  private:
     ...
     */
    inline bool dhcpIsEnabled(IP::Protocol protocol,
     ...
     *  @returns true/false value if DHCP is active for the input protocol
     */
    inline bool dhcpToBeEnabled(IP::Protocol family,
     ...
     */
    inline bool originIsManuallyAssigned(IP::AddressOrigin origin);
};
