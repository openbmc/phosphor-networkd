...
class HypNetworkMgr
{
  public:
     ...
     */
    auto makeDBusCall(const std::string& objectName, const std::string& interface, const std::string& kw);
     ...
     *
     */
    void setBIOSTableAttrs(std::string attrName, std::variant<std::string, int64_t> attrValue, std::string attrType);
