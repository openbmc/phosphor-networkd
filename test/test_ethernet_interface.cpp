...
TEST_F(TestEthernetInterface, AddIPAddress)
{
    ...
    EXPECT_THAT(interface.addrs, UnorderedElementsAre(Key("10.10.10.10/16"_sub)));
}
...
TEST_F(TestEthernetInterface, DeleteIPAddress)
{
    ...
    createIPObject(IP::Protocol::IPv4, "20.20.20.20", 16);
    interface.addrs
        .at("10.10.10.10/16"_sub)
        ->delete_();
    EXPECT_THAT(interface.addrs, UnorderedElementsAre(Key("20.20.20.20/16"_sub)));
}
