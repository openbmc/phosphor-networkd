...
class TestEthernetInterface : public stdplus::gtest::TestWithTmp
{
  public:
    ...
    auto createStaicRouteObject(std::string destination, std::string& gateway,
                               size_t prefixLength, IP::Protocol protocol)
    {
        return interface.staticRoute(destination, gateway, prefixLength, protocol);
    }
...
{
    createStaticRouteObject("10.10.10.10", 10.10.10.1, 24, IP::Protocol::IPv4);
...
{
    createStaticRouteObject("10.10.10.10", 10.10.10.1, 24, IP::Protocol::IPv4);
    createStaticRouteObject("10.20.30.10", 10.20.30.1, 24, IP::Protocol::IPv4);
    EXPECT_THAT(
