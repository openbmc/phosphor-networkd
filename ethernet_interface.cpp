                           ...
                           std::string gateway)
{
    ...
    std::string objectPath = getAddressObjectPath(static_cast<IPProtocol::Protocol>
                             (addressType));
    ...
    this->addrs.emplace(std::make_pair(ipaddress, std::make_unique <
                                       ...
                                       *this,
                                       (IPProtocol::Protocol)addressType,
...
size_t EthernetInterface::getAddressCount(IPProtocol::Protocol addressType) const
{
    size_t count = 0;
